...
class CNNBase(NNBase):
    def __init__(self, num_inputs, recurrent=False, hidden_size=2048):
        ...
        for param in self.main.encoder.parameters():
            param.requires_grad = False

        for param in self.main.decoder.parameters():
            param.requires_grad = False
    ...
    def forward(self, inputs, rnn_hxs, masks):
        mod_input = torch.reshape(inputs, (inputs.shape[0]*inputs.shape[1], 1, 96, 96)).repeat(1, 3, 1, 1)
