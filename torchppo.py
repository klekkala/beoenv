...
class PPOTorchPolicy(
    ...
    def postprocess_trajectory(
        ...
        #atari_rewards={"AirRaidNoFrameskip-v4": 8000.0, "AssaultNoFrameskip-v4": 883.0,"BeamRiderNoFrameskip-v4": 1400.0, "CarnivalNoFrameskip-v4": 4384.0,"DemonAttackNoFrameskip-v4": 415.0, "NameThisGameNoFrameskip-v4": 6000.0,"PhoenixNoFrameskip-v4":4900.0,"RiverraidNoFrameskip-v4": 8400.0,"SpaceInvadersNoFrameskip-v4":500.0}
        ...
        #atari_rewards_array = np.array(list(atari_rewards.values()))
        #index_vals = sample_batch['agent_index']
        #reward_array = np.take(atari_rewards_array, index_vals.astype(np.int64))
        #sample_batch['rewards'] *= np.divide(np.array([100.0]), reward_array)
        #print("first first first first first first")
        #print(sample_batch[SampleBatch.REWARDS])
        #sample_batch[SampleBatch.REWARDS] *= 0.0    
        with torch.no_grad():
