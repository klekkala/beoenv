...
model_n = 'RANDOM'
model_dict = {'SOM':'1CHAN_SOM_ATARI_EXPERT_1CHAN_SPACEDEMO_STANDARD_0.1_32_32_0.0001_0.pt', 'VIP':'1CHAN_VIP_ATARI_EXPERT_1CHAN_SPACEDEMO_STANDARD_50.0_15.0_0.01_32_0_0.0001_0.pt', 'TCN':'1CHAN_TCN_ATARI_EXPERT_1CHAN_SPACEDEMO_STANDARD_-1.0_32_0_0.0001_0.pt', 'VEP':'1CHAN_NVEP_ATARI_EXPERT_1CHAN_SPACEDEMO_STANDARD_2.0_-1.0_2_nsame_triplet_32_2_0.0001_1.0.pt'}
# model_dict = {'SOM':'3CHAN_SOM_BEOGYM_EXPERT_3CHAN_ALLUNIONWALL_STANDARD_0.9_triplet_32_32_0.0001_1.pt', 'VIP':'3CHAN_VIP_BEOGYM_EXPERT_3CHAN_UNIONWALL_STANDARD_50.0_15.0_32_0_0.0001_0.pt', 'VEP':'3CHAN_NVEP_BEOGYM_EXPERT_3CHAN_UNIONWALL_STANDARD_2.0_-1.0_2.0_same_32_0_0.0001_0.pt', 'TCN':'3CHAN_TCN_BEOGYM_EXPERT_3CHAN_UNIONWALL_STANDARD_2.0_32_0_0.0001_0.pt'}

# checkpoint = torch.load(f'/lab/kiran/ckpts/pretrained/atari/{model_dict[model_n]}',map_location='cuda')
# checkpoint = torch.load(f'/lab/kiran/ckpts/pretrained/beogym/{model_dict[model_n]}',map_location='cuda')
...
games=['expert_1chan_airraid', 'expert_1chan_beamrider', 'expert_1chan_carnival', 'expert_1chan_phoenix', 'expert_1chan_spaceinvaders']
# games = ['expert_3chan_allegheny', 'expert_3chan_hudsonriver', 'expert_3chan_unionsquare', 'expert_3chan_CMU', 'expert_3chan_southshore']
...
for game in games:
    ...
    plt.scatter(new_embeddings[:, 0], new_embeddings[:, 1], s=10, c=values, marker='o', label='DemonAttack')
    ...
    plt.scatter(new_embeddings[:, 0], new_embeddings[:, 1], c=values, marker='x', s= 15, linewidths=1, label=game.split("_")[-1])
    ...
    plt.legend()
    plt.title(f'{model_n}')
    plt.savefig(f'./TSNE_embedding/full/{model_n}_{game.split("_")[-1]}.png')
    plt.clf()