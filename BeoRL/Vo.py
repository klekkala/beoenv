...
class FullyConnectedNetwork(TorchModelV2, nn.Module):
    ...
    def __init__(
        ...
        prev_layer_size = int(np.product(obs_space.shape))-5
        self._logits = None
        ...
        # iff num_outputs > 0 - a last linear layer of size num_outputs.
            ...
            if num_outputs:
                ...
                self.num_outputs = ([int(np.product(obs_space.shape))-5] + hiddens[-1:])[
                    -1
                ]
        ...
        if not self.vf_share_layers:
            ...
            prev_vf_layer_size = int(np.product(obs_space.shape))-5
            vf_layers = []
            for size in hiddens:
                vf_layers.append(
                    SlimFC(
