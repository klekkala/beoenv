...
class ComplexNet(TorchModelV2, nn.Module):
    ...
    def __init__(self, obs_space, action_space, num_outputs, model_config, name):
        ...
        if not model_config['custom_model_config']['train_backbone']:
            ...
            print('not freezing')
        checkpoint = torch.load('/lab/kiran/ckpts/pretrained/beogym/3CHAN_TCN_BEOGYM_EXPERT_3CHAN_WALLSTREET_STANDARD_1.0_32_0_0.0001_0.pt')
        self.encoder = TBeoEncoder().load_state_dict(checkpoint['model_state_dict'])
        # self.cnns[1] = torch.load('/lab/kiran/ckpts/pretrained/atari/1CHAN_VIP_ATARI_EXPERT_1CHAN_SPACEDEMO_STANDARD_50.0_15.0_0.01_32_0_0.0001_0.pt')
        # embed()
