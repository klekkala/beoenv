...
#     terminal[-1] = 1
#     reward[-1] = 1
#     return np.array(images),np.array(terminal),np.array(reward)
...
for env in os.listdir(f"/lab/tmpig13b/kiran/colosseum_1m/{g}/"):
    ...
    output_file = f"/lab/tmpig13d/result_1m/{g}/{env}/50/"
...
# g = 'slide_block'
# for env in os.listdir(f"/lab/tmpig13b/kiran/colosseum_1m/{g}/"):
#     # if env == 'object_color' or env == 'object_texture' or env != 'table_texture':
#     #     continue
